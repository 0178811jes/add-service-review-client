        ...
        <div className=" grid grid-cols-1 md: grid-cols-2 lg: grid-cols-4 gap- 2">
            <div className="mockup-phone text-align-center">
                ...
                <div className="display">
                    ...
                    <h6>Q. What is the difference between SQL and SQL?</h6>
            ...
            <div className="mockup-phone text-align-center">
                ...
                <div className="display">
                    <div className="artboard artboard-demo phone-1">
                    <h6>Q. what is jwt and how it works?</h6>
            ...
            <div className="mockup-phone text-align-center">
                ...
                <div className="display">
                    <div className="artboard artboard-demo phone-1">
                    <h6>Q. defferent between javascript and nodejs?</h6>
            ...
            <div className="mockup-phone text-align-center">
                ...
                <div className="display">
                    <div className="artboard artboard-demo phone-1">
                        <h6>Q. how does node js handle multiple requests at same time</h6>
